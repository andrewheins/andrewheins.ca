...
<h2><?php comment_form_title( 'Join the Conversation!', 'Leave a Reply to %s' ); ?></h2>
...
<p><label>Got Something to Say?</label><br /><textarea name="comment" id="comment" cols="70" rows="10" tabindex="4"></textarea></p>

<p><input name="submit" type="submit" id="submit" tabindex="5" value="Submit Comment" class="button orange alignright" />
