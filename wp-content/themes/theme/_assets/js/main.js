...
// Extend backbone to provide _super function to more easily handle cases where we are extending our views
...
$(function() {
    ...
    /*
     * General Scripts
     * We automatically load scripts and run them for standard ui elements that the user is likely to see during their visit. These are the bundled scripts that come with every pageload.
     */
	...
	*/
    ...
    /*
     * Conditional Scripts
     * These are objects where we only want to load their scripts if they are going to be present on the page, either becuase they are rare or becuase their scripts are heavy.
     */
